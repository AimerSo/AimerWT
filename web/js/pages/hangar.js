...
const Hangar = {
    ...
    async refresh_list(options = {}) {
        ...
        ResourceLibraryLoading.start('hangar', { message: '正在读取机库列表...', processed: 0, total: null, show_content: false });
    ...
    _render_card_list(container, items, reveal_options = {}) {
        ...
        ResourceLibraryLoading.start('hangar', {
            message: '正在载入机库卡片...',
            processed: 0,
            total: items.length,
            show_content: false,
        ...
        const render_chunk = () => {
            ...
            if (current_index < items.length) {
                ...
                ResourceLibraryLoading.finish('hangar');
            }
        };
